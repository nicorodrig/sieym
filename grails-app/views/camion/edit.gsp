...
<html>
	...
	<body>
		...
		<div id="edit-camion" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${camionInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${camionInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${camionInstance?.version}" />
				<fieldset class="form">
