...
<html>
	...
	<body>
		<div id="edit-componenteProducto" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				<g:hiddenField name="id" value="${componenteProductoInstance?.id}" />
				<g:hiddenField name="version" value="${componenteProductoInstance?.version}" />
				<fieldset class="form">
